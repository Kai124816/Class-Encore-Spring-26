...
if __name__ == "__main__":
    ...
    # doctest.run_docstring_examples(BinaryNumber, globs=None, verbose=True, name="BinaryNumber")
    # doctest.run_docstring_examples(BinaryNumber.to_int, globs=None, verbose=True, name="BinaryNumber.to_int")

    # --- Problem 1: SignedBinaryNumber.__init__ ---
    # doctest.run_docstring_examples(SignedBinaryNumber.__init__, globs=None, verbose=True, name="SignedBinaryNumber.__init__")

    # --- Problem 2: SignedBinaryNumber.to_int ---
    # doctest.run_docstring_examples(SignedBinaryNumber.to_int, globs=None, verbose=True, name="SignedBinaryNumber.to_int")

    # --- Problem 3: SignedBinaryNumber.__gt__ ---
    # doctest.run_docstring_examples(SignedBinaryNumber.__gt__, globs=None, verbose=True, name="SignedBinaryNumber.__gt__")

    # --- Problem 4: SignedBinaryNumber.__lt__ ---
    # doctest.run_docstring_examples(SignedBinaryNumber.__lt__, globs=None, verbose=True, name="SignedBinaryNumber.__lt__")

    # --- Problem 5: SignedBinaryNumber.__lshift__ / __rshift__ ---
    # doctest.run_docstring_examples(SignedBinaryNumber.__lshift__, globs=None, verbose=True, name="SignedBinaryNumber.__lshift__")
    # doctest.run_docstring_examples(SignedBinaryNumber.__rshift__, globs=None, verbose=True, name="SignedBinaryNumber.__rshift__")

    # --- Problem 6: binary_and ---
    # doctest.run_docstring_examples(binary_and, globs=None, verbose=True, name="binary_and")

    # --- Problem 7: binary_or ---
    # doctest.run_docstring_examples(binary_or, globs=None, verbose=True, name="binary_or")

    # --- Problem 8: exists_in_nested_list ---
    # doctest.run_docstring_examples(exists_in_nested_list, globs=None, verbose=True, name="exists_in_nested_list")

    # --- Problem 9: nested_list_sum ---
    # doctest.run_docstring_examples(nested_list_sum, globs=None, verbose=True, name="nested_list_sum")

    # --- Problem 10: nested_dict_keys ---
    # doctest.run_docstring_examples(nested_dict_keys, globs=None, verbose=True, name="nested_dict_keys")